...
Then standard error is standard error of the estimator so:
...
Suppose I take 1000 samples of size 40 from the population where and $u_i \sim N(0,2)$:
...
**Average response**:
What would be average number of rides if temperature is 30C?
