...
With visual and numerical tests we can analyze:
- Normality
...
gg2 <- ggplot(data.frame(Fitted = fitted_values_linear, Residuals = residuals_linear), aes(x = Fitted, y = Residuals)) +
  ...
  geom_smooth(method = "loess", se = FALSE, color = "darkgreen", linewidth = 0.8, linetype = "dashed") +
...
<div class="learnr-ref">LearnR: 8.1–8.2 Linearity Check (House Prices, CEO Pay)</div>

---
### Constant variance: Heteroskedastic Example
...
---
### Constant variance: Homoskedastic Example
...
<div class="learnr-ref">LearnR: 8.3–8.4 Homoskedasticity (Sex Ratios, House Prices)</div>
...
### Normality: Histogram Overview

We can start by looking at histograms
- Some are obvious

<div class="learnr-ref">LearnR: 8.5–8.6 Normality Check (Mutual Funds, House Prices)</div>
...
---
### Normality: Exponential Residuals
We can start by looking at histograms
- Some are obvious
...
---
### Normality: Q-Q Plot Concept


**Q-Q Plot**: Quantile-Quantile Plot

- Comparing quantiles of our data to what they should be if they came from a normal distribution
...
---
### Q-Q Plot: Calculating Quantiles
...
### Q-Q Plot: Normal Data (Interactive)
.pull-left[
...
histogram_plot <- ggplot(data_df, aes(x = scale(Residuals))) +
  geom_histogram(binwidth = 0.4, aes(y = after_stat(density)), fill = "steelblue", color = "black", alpha = 0.7) +
...
**Intuition**
- Skewness of normal distribution is 0 (it's symmetric)
...
---
### Jarque-Bera Test: The Statistic
...
- Its value will be high if:
  - Skewness deviates significantly from 0
...
---
### Jarque-Bera Test: Hypothesis Testing
...
---
### Jarque-Bera Test: Non-Normal Example
...
| Constant variance | Residuals vs. Fitted plot | Even spread across range |
| Normality | Q-Q plot, Jarque-Bera test | Points on 45° line, JB p-value > α |
| No autocorrelation | Residuals vs. order plot | No systematic pattern |

--

**Key takeaways:**
- Always check assumptions **after** fitting the regression
- Residual plots are the primary visual diagnostic
- Q-Q plots compare residual quantiles to theoretical normal quantiles
- Jarque-Bera test formalizes normality checking via skewness and kurtosis
- Violations suggest the model may need transformation or a different specification