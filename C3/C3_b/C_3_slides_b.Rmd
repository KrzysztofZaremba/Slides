...
- Assume we have $n>30$
  - CLT applies and $\bar{X} \sim N(\mu_X, \frac{\sigma_X}{n})$ 
...
$$P(\bar{X}<k_2)=P(\bar{X}-\mu_X<k_2-\mu_X)=P(\underbrace{\frac{\bar{X}-\mu_X}{ \frac{\sigma_X}{n}}}_{Z \sim N(0,1)}<\underbrace{\frac{k_2-\mu_X}{ \frac{\sigma_X}{n}}}_{k_2'})$$
--
...
--
- Let's go back to $k_2'=\frac{k_2-\mu_X}{ \frac{\sigma_X}{n}}$, from which we can back-out $k_2$

--
  - $k_2=\mu_X+\frac{\sigma_X}{n} k_2'=\mu_X+1.96\frac{\sigma_X}{n}$

--
- By symmetry of normal, $k'_1=-k'_2$, so $k_1=\mu_X+\frac{\sigma_X}{n} k_1'=\mu_X-1.96\frac{\sigma_X}{n}$
...
- Another way to see it: 
  - Our variable is a linear transformation of a standard normal: $\bar{X}=\mu_X+\frac{\sigma_X}{n} Z$
  
--
  - So its percentiles are linear transformation of st.nor. quantiles:  $v_{0.975}^\bar{X}=\mu_X+\frac{\sigma_X}{n}v_{0.975}^Z$
---
...
- Confidence interval of $\bar{X}$ will cover $\mu_X$ as long as $|\mu_X-\bar{X}|<1.96\frac{\sigma_X}{n}$
...
3. Pick confidence level (usually 90,95,99%)
  ...
  - .blue[Example]: if confidence level is 95%, $\alpha=0.05$
...
4. Find the corresponding critical values $z_{\frac{\alpha}{2}}$
  ...
  - .blue[Example]: if confidence level is 95%, $z_\frac{\alpha}{2}=z_{0.025}=1.96$
--

5. Construct the confidence interval as:
$$\{\bar{x}- z_{\frac{\alpha}{2}}*\underbrace{\frac{s}{\sqrt n}}_{SE}, \bar{x}+ z_{\frac{\alpha}{2}}*\frac{s}{\sqrt n}\}$$
