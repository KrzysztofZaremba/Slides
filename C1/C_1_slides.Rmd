...
- **70% In-Class Exams & Assignments**  
  ...
  - Combination of applied (in computer lab) and paper-based formats  
...
- **5% In-Class Assignments**  
  - 2 group forecasting competitions using real-world data  
  - 2 individual theoretical quizzes (1 cheat sheet allowed)  
...
- **5% Participation & Engagement**  
  - 2.5%: Flipped tasks and short homeworks (graded for completion)  
...
- **Penalties are severe**:
  ...
  - Cheating has been reported in this course before.
