...
- .blue[Very Short Horizon:]
  - High-Frequency Trading: 
      - Real-time price predictions for financial trading
  - Traffic Flow Management: 
      - Optimizing traffic signals based on real-time data
--

- .blue[Short Horizon]:
  - Retail Store: 
    - Forecasting cashier scheduling based on historical foot traffic and transaction data
  - Public bikes: 
    - Predict the availability of bikes at bike station and adjust the number
--

- .blue[Long Horizon]:
  - New obesity drug: 
    - Forecasting number of potential patients and their resources
  - Investing in new country: 
    - Forecasting political stability
---
