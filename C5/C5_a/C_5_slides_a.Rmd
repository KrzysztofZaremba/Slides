...
- Suppose we estimate the two models:
    - If the **null hypothesis are true**, then the errors in restricted and unrestricted model should be similar
    - If the **null is not true**, errors in restricted model should be larger: because we got the model wrong!
