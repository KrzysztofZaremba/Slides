...
## 🧮 Exercise 0: Explore the Data Table
...
## 🧠 Exercise 1: Categorical vs Numerical Variables
...
## 📈 Exercise 2: Frequency Table for Categorical Data

We often summarize categorical variables using frequency and proportion tables. Let’s see how often each value of `location_type` occurs.
...
## 📊 Exercise 3: Bar Plot of Categorical Data
...
## 📊 Exercise 4: Bar Plot with Relative Frequencies
...
## 🥧 Exercise 5: Pie Chart of Categorical Data

Another way to visualize proportions is with a pie chart. Let’s create one for `Difficulty_walking`.
...
## 📊 Exercise 6: What About Age?

Let’s examine the `age` variable. How many unique values are there? This helps determine whether it's categorical or continuous.
...
# Pie chart of age — usually not recommended for numeric variables
...
## 📉 Exercise 8: Histogram of a Numerical Variable

Histograms are a better way to visualize the distribution of numerical variables. Let’s create one for `weight`.
...
## 📦 Exercise 9: Summary Statistics and Boxplot

Let’s look at some key percentiles and visualize the distribution of `weight` with a boxplot.
...
Let’s explore how quantiles divide a distribution. Move the slider to select a quantile. The histogram will update to highlight the proportion of data below the selected cutoff.
...
## 🧪 Interactive Exploration: Covariance, Correlation, and Transformations

We’ll simulate variables \(X\) and \(Y\), then explore how adding or scaling affects their **covariance** and **correlation**.
...
### 📊 Output: Scatterplot and Summary
